...
import View.Swing.ShadowRenderer;
...
public class Notificacion extends javax.swing.JComponent {
    ...
    public Notificacion(Frame fram, Type type, Location location, String message) {
        this.fram = fram;
        this.type = type;
    ...
    //Se crea el JDialog y se cambia la imagen segun el tipo, ademas de establecer el mensaje
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Icon/sucess.png")));
            lbMessage.setText("Exitoso");
        } else if (type == Type.INFO) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Icon/info.png")));
            lbMessage.setText("Info");
        } else {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Icon/warning.png")));
            lbMessage.setText("Peligro");
        }
        lbMessageText.setText(message);
    }
    
    //Metodo para animar el cuadro de dialogo
    private void initAnimator() {
        TimingTarget target = new TimingTargetAdapter() {
            ...
            //Saca el cuadro por la orientacion establecida
            @Override
            public void begin() {
                if (!showing) {
            ...
            //cierra el cuadro desbaneciendolo
            @Override
            public void end() {
                showing = !showing;
                if (showing) {
    ...
    //Metodo para que el cuadro de dialogo sea visible
    public void showNotification() {
        animator.start();
    }

    //Tras finalizar el sleep cierra el cuadro
    ...
    //Temporizador para el cuadro de dialogo
    private void sleep() {
        try {
            Thread.sleep(3000);
    ...
    //Establece los limites del cuadro de la imagen para crear la sombra
    @Override
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Icon/sucess.png"))); // NOI18N
        ...
        lbMessageText.setText("Mensaje Texto");
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Icon/close.png"))); // NOI18N
    ...
    //Enum para las posiciones de la pantalla
