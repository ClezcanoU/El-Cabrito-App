...
import View.Component.CardMenuELIMINAR;
import java.util.ArrayList;
import java.util.List;
import javax.swing.ImageIcon;


public class Form_TomarOrdenEliminar extends javax.swing.JFrame {

    public Form_TomarOrdenEliminar() {
        initComponents();
        headerMoving.initMoving(Form_TomarOrdenEliminar.this);
        init();
    }
    ...
    private void init() {
        ...
        if (productos.size() >= 24) {
            ...
            for (int i = 1; i <= 24; i++) {
                ...
                CardMenuELIMINAR cardMenu = obtenerCardMenuSegunIndice(i);
    ...
    private CardMenuELIMINAR obtenerCardMenuSegunIndice(int indice) {
        switch (indice) {
    ...
    private void initComponents() {
        ...
        cardMenu1 = new View.Component.CardMenuELIMINAR();
        cardMenu2 = new View.Component.CardMenuELIMINAR();
        cardMenu3 = new View.Component.CardMenuELIMINAR();
        cardMenu4 = new View.Component.CardMenuELIMINAR();
        cardMenu5 = new View.Component.CardMenuELIMINAR();
        cardMenu6 = new View.Component.CardMenuELIMINAR();
        cardMenu7 = new View.Component.CardMenuELIMINAR();
        cardMenu8 = new View.Component.CardMenuELIMINAR();
        cardMenu9 = new View.Component.CardMenuELIMINAR();
        cardMenu10 = new View.Component.CardMenuELIMINAR();
        cardMenu11 = new View.Component.CardMenuELIMINAR();
        cardMenu12 = new View.Component.CardMenuELIMINAR();
        cardMenu13 = new View.Component.CardMenuELIMINAR();
        cardMenu14 = new View.Component.CardMenuELIMINAR();
        cardMenu15 = new View.Component.CardMenuELIMINAR();
        cardMenu16 = new View.Component.CardMenuELIMINAR();
        cardMenu17 = new View.Component.CardMenuELIMINAR();
        cardMenu18 = new View.Component.CardMenuELIMINAR();
        cardMenu19 = new View.Component.CardMenuELIMINAR();
        cardMenu20 = new View.Component.CardMenuELIMINAR();
        cardMenu21 = new View.Component.CardMenuELIMINAR();
        cardMenu22 = new View.Component.CardMenuELIMINAR();
        cardMenu23 = new View.Component.CardMenuELIMINAR();
        cardMenu24 = new View.Component.CardMenuELIMINAR();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_TomarOrdenEliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_TomarOrdenEliminar().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private View.Component.CardMenuELIMINAR cardMenu1;
    private View.Component.CardMenuELIMINAR cardMenu10;
    private View.Component.CardMenuELIMINAR cardMenu11;
    private View.Component.CardMenuELIMINAR cardMenu12;
    private View.Component.CardMenuELIMINAR cardMenu13;
    private View.Component.CardMenuELIMINAR cardMenu14;
    private View.Component.CardMenuELIMINAR cardMenu15;
    private View.Component.CardMenuELIMINAR cardMenu16;
    private View.Component.CardMenuELIMINAR cardMenu17;
    private View.Component.CardMenuELIMINAR cardMenu18;
    private View.Component.CardMenuELIMINAR cardMenu19;
    private View.Component.CardMenuELIMINAR cardMenu2;
    private View.Component.CardMenuELIMINAR cardMenu20;
    private View.Component.CardMenuELIMINAR cardMenu21;
    private View.Component.CardMenuELIMINAR cardMenu22;
    private View.Component.CardMenuELIMINAR cardMenu23;
    private View.Component.CardMenuELIMINAR cardMenu24;
    private View.Component.CardMenuELIMINAR cardMenu3;
    private View.Component.CardMenuELIMINAR cardMenu4;
    private View.Component.CardMenuELIMINAR cardMenu5;
    private View.Component.CardMenuELIMINAR cardMenu6;
    private View.Component.CardMenuELIMINAR cardMenu7;
    private View.Component.CardMenuELIMINAR cardMenu8;
    private View.Component.CardMenuELIMINAR cardMenu9;
